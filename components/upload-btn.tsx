  ...
  const startSimulatedProgress = () => {
    ...
    const interval = setInterval(() => {
      setUploadProgress((prevProgress) => {
        ...
        // Here 5 represents the amount of progress to be made
        // in each interval (in this case 500ms)
  ...
  return (
    ...
    >
      {({ getRootProps, getInputProps, acceptedFiles }) => (
        ...
        >
          <div className="flex items-center justify-normal h-full w-full">
            <label
